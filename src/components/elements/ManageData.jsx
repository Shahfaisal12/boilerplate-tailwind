...
const ManageData = () => {
  return (
    <div className="ManageData-section py-10">
      <div className="flex max-w-[1240px] m-auto items-center grid lg:grid-cols-2 gap-5 px-4 py-10 ">
        ...
        <div className="flex flex-col">
          ...
          <h6 className="text-xl text-black">
            ...
            accusantium vitae? Distinctio quos dolore ducimus nostrum ab aperiam
            assumenda sed, nam, eum qui ut. Labore aut ipsam minima repellat.
          </h6>
          <Link
            to="/"
      ...
      <div className="flex mt-5 max-w-[1240px] w-full m-auto items-center grid lg:grid-cols-2 gap-5 px-4 py-10">
        <div className="flex flex-col">
          <h6 className="text-xl font-bold uppercase text-[#00df9a] p-1">
            data Analytics Dashboard
          </h6>
